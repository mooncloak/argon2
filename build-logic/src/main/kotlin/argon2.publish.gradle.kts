...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("argon2")
        description.set("Kotlin multi-platform Argon2id password hashing function implementation.")
        url.set("https://github.com/mooncloak/argon2")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/argon2/issues")
        ...
        developers {
            developer {
                ...
                roles.set(setOf("Primary argon2 developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/argon2.git")
            developerConnection.set("https://github.com/mooncloak/argon2.git")
            url.set("https://github.com/mooncloak/argon2")
        }
    }
}
